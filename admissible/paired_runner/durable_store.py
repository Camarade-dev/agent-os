...
#: An observer fails after a durable STARTED record exists.
FAULT_OBSERVER_FAILURE_AFTER_STARTED = "OBSERVER_FAILURE_AFTER_STARTED"
#: The capsule supervisor dies while the effect is in flight.
FAULT_SANDBOX_SUPERVISOR_DEATH = "SANDBOX_SUPERVISOR_DEATH"
FAULT_DURING_LEDGER_PENDING_PUBLICATION = f"{STAGE_LEDGER_PENDING_PUBLICATION}:TEMP_WRITE"
FAULT_BEFORE_FINAL_RECONCILIATION = "BEFORE_FINAL_RECONCILIATION_PUBLICATION"
FAULT_DURING_FINAL_RECONCILIATION_PUBLICATION = f"{STAGE_FINAL_RECONCILIATION_PUBLICATION}:TEMP_WRITE"
